  ...
  return (
    <main className="adm">
      ...
      <div className="adm-table">
        {tab === "perfil" ? (
          <table>
            <thead><tr><th>Fecha</th><th>Nombre</th><th>Correo</th><th>Organización</th><th>Sector</th><th>Área</th><th>Nivel</th><th>Decisión</th><th>Contacto</th></tr></thead>
            <tbody>
              {participants.length === 0 && <tr><td colSpan={9} className="empty">Todavía no hay respuestas.</td></tr>}
              {participants.map((p) => (
                <tr key={p.id}>
          ...
          <table>
            <thead><tr><th>Fecha</th><th>Token</th><th>Edad</th><th>Padecimientos</th><th>Antecedentes</th><th>Actividad</th><th>Sueño</th><th>Chequeo</th><th>Estrés</th><th>Salud</th><th>Tabaco</th><th>Ultraprocesados</th></tr></thead>
            <tbody>
              {records.length === 0 && <tr><td colSpan={12} className="empty">Todavía no hay respuestas.</td></tr>}
              {records.map((r) => (
                <tr key={r.id}>
